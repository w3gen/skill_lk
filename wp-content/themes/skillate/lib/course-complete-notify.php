<div class="course-complete-notify-panel">
    <span class="notify-close"><i class="fa fa-times"></i></span>
        ...
        <div class="notify-panel-content">
            <div class="svg radial-progress">
                ...
                <div class="circle-content">
                    <h2><?php echo esc_html__('100%', 'skillate'); ?></h2>
                </div>
                <svg height="10em" width="10em" viewBox="0 0 60 60">
                <circle class="radial-progress-background" r="" cx="2em" cy="2em" fill="transparent" stroke-dasharray="0em" stroke-dashoffset="0em"></circle>
                <circle class="radial-progress-cover" r="" cx="2em" cy="2em" fill="transparent" stroke-dasharray="0em" stroke-dashoffset="0"></circle>
                <circle class="radial-progress-center" r="" cx="2em" cy="2em" fill="transparent" stroke-dasharray="0em" stroke-dashoffset="0em"></circle>
                </svg>
            </div>
            <h3><?php echo esc_html__('You are awesome!','skillate'); ?></h3>
            <p><?php echo esc_html__('Congratulations! You have successfully completed the course! ', 'skillate'); ?></p>
        </div>
    </div>
