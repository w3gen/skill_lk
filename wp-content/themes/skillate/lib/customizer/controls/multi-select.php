...
if( class_exists( 'WP_Customize_Control' ) && !class_exists( 'SKILLATE_THMC_Multi_Select_Control' ) ):
	/**
	* 
	*/
	class SKILLATE_THMC_Multi_Select_Control extends WP_Customize_Control
	{
