...
if( class_exists( 'WP_Customize_Control' ) && !class_exists( 'SKILLATE_THMC_Checkbox_Button_Control' ) ):
	/**
	* 
	*/
	class SKILLATE_THMC_Checkbox_Button_Control extends WP_Customize_Control
	{
