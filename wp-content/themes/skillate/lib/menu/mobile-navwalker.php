...
class wp_bootstrap_mobile_navwalker extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if (strcasecmp($item->attr_title, 'divider') == 0 && $depth === 1) {
            ...
            $class_names = join( ' ', apply_filters( 'skillate_nav_menu_css_class', array_filter( $classes ), $item, $args ) );
            ...
            $id = apply_filters( 'skillate_nav_menu_item_id', 'menu-item-'. $item->ID, $item, $args );
            ...
            $atts = apply_filters( 'skillate_nav_menu_link_attributes', $atts, $item, $args );
            ...
            $item_output .= $args->link_before . apply_filters( 'skillate_the_title', $item->title, $item->ID ) . $args->link_after;
            $item_output .=  '</a>';
            ...
            if($args->has_children) {
                ...
                <img src="'.get_template_directory_uri().'/images/mobile-nav-icon/mobile-menu-angle.svg"/>
                </span>';
            }


            $output .= apply_filters( 'skillate_walker_nav_menu_start_el', $item_output, $item, $depth, $args );
        }
    }
