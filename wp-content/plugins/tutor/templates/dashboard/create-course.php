                ...
                <div class="tutor-row">
                    ...
                    <div class="tutor-col-4">
                        <div class="tutor-course-builder-upload-tips">
                            <h3 class="tutor-course-builder-tips-title"><i class="tutor-icon-light-bulb"></i><?php _e('Course Creation Tips', 'tutor') ?></h3>
                            <ul>
                                <li><?php _e("Course Builder is where you create & organize a course.", 'tutor');?></li>
                                <li><?php _e("Once you create/update course, it will not be available for students until SKILL.LK approves your course content.", 'tutor'); ?></li>
                                <li><?php _e("Set the Course Price option or make it free.", 'tutor');?></li>
                                <li><?php _e("Always try to create your own youtube channel and link your videos here.", 'tutor');?></li>
                                <li><?php _e("Always upload your course content into GOOGLE DRIVE or ONE DRIVE and share the downloadable link in your lesson.", 'tutor');?></li>
                             ...
                             <i class="tutor-icon-warning-2"></i>
                             <?php _e('Disclaimer', 'tutor') ?></h3>
                                                        <ul>
                                                            <li><?php _e("Skill.lk will not approve promotional material. Avoid promoting websites and youtube channels in your course", 'tutor');?></li>
                                                            <li><?php _e("Skill.lk will own the right to allow or restrict third party content in courses.", 'tutor');?></li>
                                                           </ul>
                        </div>
                    </div> <!--.tutor-col-4-->
                </div> <!--.tutor-row-->
